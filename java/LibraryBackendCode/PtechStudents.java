...
public class PtechStudents extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword);
            ...
            // Prepare statements
            String checkSql = "SELECT COUNT(*) FROM Ptech_students WHERE crn = ?";
            String insertSql = "INSERT INTO Ptech_students (crn, name, course, contact) VALUES (?, ?, ?, ?)";
            String updateSql = "UPDATE Ptech_students SET name = ?, course = ?, contact = ? WHERE crn = ?";
            ...
            out.print("\"message\": \"Polytechnic student import completed successfully\",");
