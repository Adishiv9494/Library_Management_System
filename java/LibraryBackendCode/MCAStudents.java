...
public class MCAStudents extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword);
            ...
            // Prepare statements
            String checkSql = "SELECT COUNT(*) FROM MCA_students WHERE crn = ?";
            String insertSql = "INSERT INTO MCA_students (crn, name, course, contact) VALUES (?, ?, ?, ?)";
            String updateSql = "UPDATE MCA_students SET name = ?, course = ?, contact = ? WHERE crn = ?";
            ...
            out.print("\"message\": \"MCA student import completed successfully\",");
