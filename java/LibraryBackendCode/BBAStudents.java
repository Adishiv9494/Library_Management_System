...
public class BBAStudents extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword);
            ...
            // Prepare statements
            String checkSql = "SELECT COUNT(*) FROM BBA_students WHERE crn = ?";
            String insertSql = "INSERT INTO BBA_students (crn, name, course, contact) VALUES (?, ?, ?, ?)";
            String updateSql = "UPDATE BBA_students SET name = ?, course = ?, contact = ? WHERE crn = ?";
            ...
            out.print("\"message\": \"BBA student import completed successfully\",");
