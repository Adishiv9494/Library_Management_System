...
public class MBAStudents extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) 
        ...
        try (Connection conn = DriverManager.getConnection(dbURL, dbUser, dbPassword);
            ...
            // Prepare statements
            String checkSql = "SELECT COUNT(*) FROM MBA_students WHERE crn = ?";
            String insertSql = "INSERT INTO MBA_students (crn, name, course, contact) VALUES (?, ?, ?, ?)";
            String updateSql = "UPDATE MBA_students SET name = ?, course = ?, contact = ? WHERE crn = ?";
            ...
            out.print("\"message\": \"MBA student import completed successfully\",");
